...
<body>
    ...
    <ul id="menu" class="ui-menu" style="font-family: &quot;Trebuchet MS&quot;, &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, &quot;Lucida Sans&quot;, Arial, sans-serif; font-size: medium">
        <li><span class="ui-icon ui-icon-home"></span>Home
            <ul>
                <li class="ui-state-disabled"><span class="ui-icon ui-icon-mail-open"></span><a href="#">Inbox</a></li>
 ...
 <?php   
        ...
        $sql = "SELECT id,fromuser,subject from snhumail where username='".$_SESSION["username"]."' and type='inbox'";
        ...
        echo "<br/><br/><br/><br/><center><table><col width='25'><col width='255'><col width='350'><tr><th></th><th>From</th><th>Subject</th></tr>";
        while($row = mysql_fetch_array($retval, MYSQL_ASSOC))
        {
            echo "<tr><td><a href='delete.php?id=" . $row['id'] . "&type=inbox'><input type='button' value='Delete'></a></td><td>".$row["fromuser"]."</td><td><a href='readmail.php?id=".$row["id"]."'>".$row["subject"]."</a></td></tr>";
        } 
         echo "</table></center>";
