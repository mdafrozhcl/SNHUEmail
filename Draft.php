...
<body>
    ...
    <ul id="menu" class="ui-menu" style="font-family: &quot;Trebuchet MS&quot;, &quot;Lucida Sans Unicode&quot;, &quot;Lucida Grande&quot;, &quot;Lucida Sans&quot;, Arial, sans-serif; font-size: medium">
        <li><span class="ui-icon ui-icon-home"></span>Home
            <ul>
                ...
                <li class="ui-state-disabled"><span class="ui-icon ui-icon-note"></span><a href="#">Draft</a></li>
    ...
    <?php
        ...
        $sql = "SELECT id,username,subject from snhumail where fromuser='".$_SESSION["username"]."' and type='draft'";
        ...
        {
            echo "<tr><td><a href='delete.php?id=" . $row['id'] . "&type=draft'><input type='button' value='Delete'></a></td><td>".$row["username"]."</td><td><a href='readmail.php?id=".$row["id"]."'>".$row["subject"]."</a></td></tr>";
        } 
        echo "</table></center>";
